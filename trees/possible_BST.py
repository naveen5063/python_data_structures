...
def constructTrees(start, end):
    ...
    for i in range(start, end + 1):
        ...
        print("len(leftSubtree)", len(leftSubtree))
        print("len(rightSubtree)", len(rightSubtree))
...
if __name__ == '__main__':
    ...
    print("totalTreesFrom1toN", len(totalTreesFrom1toN))
